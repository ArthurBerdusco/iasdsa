...
export default function CultosAdmin() {
  ...
  const createCulto = async (e: FormEvent) => {
    ...
    try {
      ...
      formData.append("data", currentCulto.data instanceof Date
        ? currentCulto.data.toISOString()
        : String(currentCulto.data));
                  ...
                  cultos.map((culto) => (
                    <tr key={culto.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm">
                        <span className={`px-2 py-1 rounded-full text-xs ${culto.cordestaque === "primary" ? "bg-blue-100 text-blue-800" :
